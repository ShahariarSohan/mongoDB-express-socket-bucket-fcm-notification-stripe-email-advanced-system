...
const imageFilter = (req: any, file: any, cb: any) => {
  const allowedMimes = ["image/png", "image/jpeg", "image/jpg", "image/webp", "image/gif", "image/svg+xml", "image/tiff", "image/bmp", "image/heic","image/svg","image/avif","application/pdf",];
...
// Deal assets: multiple images + single QR code image
const uploadDealAssets = upload.fields([
  { name: "images", maxCount: 30 },
  { name: "qrCode", maxCount: 1 },
  { name: "barCodeImg", maxCount: 5 },
]);
